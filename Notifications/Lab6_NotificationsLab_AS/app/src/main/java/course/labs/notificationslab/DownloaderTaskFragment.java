...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> resIDs = args.getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);
		
		// Start the DownloaderTask
		new DownloaderTask().execute(resIDs);
	...
	public class DownloaderTask extends AsyncTask<ArrayList<Integer>, Void, String[]> {
		...
		@Override
		protected String[] doInBackground(ArrayList<Integer>... resIDs) {
			return downloadTweets(resIDs[0].toArray(new Integer[0]));
		}
			...
			mContext.sendOrderedBroadcast(new Intent(MainActivity.DATA_REFRESHED_ACTION), null,
					new BroadcastReceiver() {
						...
						public void onReceive(Context context, Intent intent) {
							...
							if (MainActivity.IS_ALIVE != getResultCode()) {
								...
								PendingIntent pending = PendingIntent.getActivity(
										mContext, 0, restartMainActivityIntent, PendingIntent.FLAG_UPDATE_CURRENT);
